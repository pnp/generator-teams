...
export class ManifestGenerator extends BaseManifestGenerator {
    ...
    public generateManifest(options: GeneratorTeamsAppOptions): any {
        ...
        manifest["$schema"] = "https://developer.microsoft.com/en-us/json-schemas/teams/v1.12/MicrosoftTeams.schema.json";
        manifest.manifestVersion = "1.12";

        return manifest;
    }

    public supportsUpdateManifest(from: string): boolean {
        return from === "1.8" || from === "1.9" || from === "1.10" || from === "1.11";
    }

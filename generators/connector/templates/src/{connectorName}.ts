        ...
        return this.connectors.map(connector => {
            return new Promise<void>((resolve, reject) => {
                ...
                let body = {
                    ...
                    "text": "This is a card from the WWAZDemoConnector",
                    "sections": [
                        {
                            "activityTitle": "Ping",
                            "activitySubtitle": "Manual ping",
                            "activityText": "This card is from a manual ping",
                            "activityImage": "https://wwazdemotab.azurewebsites.net/assets/card.png",
                            "facts": [
                                {
                                    "name": "Created by",
                    ...
                    "potentialAction": [{
                        ...
                        "@type": "ViewAction",
                        "name": "Go to site",
                        "target": ["https://wwazdemotab.azurewebsites.net"]
                    }],
                    "themeColor": "#FF69B4"
                };

...
class BotGenerator extends Generator {
    ...
    writing() {
        if (this.options.bot) {
            ...
            let templateFiles = [];
            if (this.options.staticTab) {
                templateFiles.push("src/app/scripts/{botName}/{staticTabName}Tab.tsx", "src/app/web/{botName}/{staticTabName}Tab.html", "src/app/{botName}/dialogs/HelpDialog.ts", "src/app/{botName}/dialogs/WelcomeCard.json", "src/app/{botName}/dialogs/WelcomeDialog.ts");

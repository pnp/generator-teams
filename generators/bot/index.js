...
class BotGenerator extends Generator {
    ...
    writing() {
        if (this.options.bot) {
            ...
            // update client.ts
            if (this.options.staticTab) {
                Yotilities_1.Yotilities.insertTsExportDeclaration("src/app/scripts/client.ts", `./${this.options.staticTabName}Tab`, `Automatically added for the ${this.options.staticTabName} bot tab`, this.fs);
            }
            Yotilities_1.Yotilities.insertTsExportDeclaration("src/app/TeamsAppsComponents.ts", `./${this.options.botName}`, `Automatically added for the ${this.options.botName} bot`, this.fs);
        }
    }
}
